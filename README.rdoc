...
3. <tt>git clone https://github.com/noah/ocelot.git</tt>
...
<tt>hello.odf</tt>, with a very special message inside.

== Development

Like most jruby projects, <tt>ocelot</tt> uses a combination of ruby
